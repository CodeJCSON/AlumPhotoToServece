...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *cancelButton = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStyleBordered target:self.parent action:@selector(cancelImagePicker)];
...
- (void)reloadTableView
{
    ...
    //self.navigationController.navigationBar.backgroundColor = [UIColor colorWithRed:166 / 255.0 green:183 / 255.0 blue:51 / 255.0 alpha:1];
